...
const TASK_SEEDS: MockTaskSeed[] = [
  { id: "task-001", title: "Configurar WebSocket reconnect", status: "In Progress", assignees: ["Daniel"], dueOffsetDays: 3, projectName: "Jarvis", priority: "Medium" },
  ...
  { id: "task-004", title: "Diseñar onboarding de voz", status: "Blocked", assignees: ["Daniel"], dueOffsetDays: 12, projectName: "Jarvis", priority: "Medium" },
  ...
  { id: "task-007", title: "Refactor del executor", status: "In Progress", assignees: ["Pablo"], dueOffsetDays: null, projectName: "Jarvis", priority: "Medium" },
  { id: "task-008", title: "Revisión de seguridad del approval flow", status: "Done", assignees: ["Pablo"], dueOffsetDays: -10, projectName: "Jarvis", priority: "High" },
  ...
  { id: "task-010", title: "Actualizar dependencias", status: "To Do", assignees: ["Pablo"], dueOffsetDays: 14, projectName: "Jarvis", priority: "Low" },

  { id: "task-011", title: "Bundle del API como Tauri sidecar", status: "To Do", assignees: ["Jose"], dueOffsetDays: 7, projectName: "Jarvis", priority: "High" },
  { id: "task-012", title: "Configurar ElevenLabs TTS", status: "To Do", assignees: ["Jose"], dueOffsetDays: null, projectName: "Jarvis", priority: "Medium" },
  { id: "task-013", title: "Plan de integraciones Notion fase 2", status: "In Progress", assignees: ["Jose"], dueOffsetDays: 4, projectName: "Jarvis", priority: "Medium" },
  { id: "task-014", title: "QA general del MVP", status: "Done", assignees: ["Jose"], dueOffsetDays: -5, projectName: "Jarvis", priority: "Medium" },
  ...
  { id: "task-020", title: "Migrar base de datos a Postgres", status: "To Do", assignees: ["Camilo"], dueOffsetDays: 30, projectName: "Jarvis", priority: "Low" },
  ...
  { id: "task-022", title: "Pruebas de carga del API", status: "In Progress", assignees: ["Camilo"], dueOffsetDays: 8, projectName: "Jarvis", priority: "Medium" },
  { id: "task-023", title: "Resolver bug de cancelación de streaming", status: "To Do", assignees: ["Camilo"], dueOffsetDays: -1, projectName: "Jarvis", priority: "High" },
...
const PROJECT_SEEDS: MockProjectSeed[] = [
  { id: "project-jarvis", title: "Jarvis", status: "In Progress", owner: "Jose", dueOffsetDays: 60 },
