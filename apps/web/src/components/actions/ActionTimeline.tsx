  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-2 p-3 border-b border-jarvis-border">
        ...
        <span className="text-xs text-jarvis-subtle tracking-widest uppercase">Action Timeline</span>
      </div>

      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        {!hasActivity && (
          <div className="text-[11px] text-jarvis-border text-center mt-6">No actions yet</div>
        )}
        ...
        <AnimatePresence>
          {approvals.map((approval) => (
            <motion.div
              ...
              className={`jarvis-card rounded p-2 text-xs border-l-2 ${
            ...
            >
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-jarvis-muted">APPROVAL</span>
              ...
              <div className="text-jarvis-subtle mt-0.5 text-[10px]">{formatTime(approval.createdAt)}</div>
            </motion.div>
          ))}
